...
7. **04 — Propuesta de valor** — el recorrido de lectura (Leer → Entender
   ...
   (oración), Magisterium (conocimiento/IA), Según tu Palabra (Biblia +
   comunidad + herramientas + distribución).
...
10. **07 — La inversión** — 100.000€ + un desglose proporcional real (los
